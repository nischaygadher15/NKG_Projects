...
{
    let atomicNo = parseInt(this.firstElementChild.innerHTML);
    if (atomicNo != eleNo)
    {
        indexNo = atomicNo - 1;
        ...
        document.getElementById("eleTitle").innerText = elements[indexNo]["name"];
        document.getElementById("eleCategory").innerText = elements[indexNo]["category"];
        document.getElementById("eleDiscovered").innerText = elements[indexNo]["discovered_by"];
        document.getElementById("eleState").innerText ="";
        document.getElementById("eleWeight").innerText = elements[indexNo]["atomic_mass"];
        document.getElementById("eleEnergy").innerText = elements[indexNo]["shells"];
        document.getElementById("eleEleN").innerText = elements[indexNo]["electronegativity_pauling"];
        document.getElementById("eleMelting").innerText = elements[indexNo]["melt"];
        document.getElementById("eleBoiling").innerText = elements[indexNo]["boil"];
        document.getElementById("eleEleAf").innerText = elements[indexNo]["electron_affinity"];
        document.getElementById("eleIonization").innerText = elements[indexNo]["ionization_energies"][0];
        document.getElementById("eleDensity").innerText = elements[indexNo]["density"];
        document.getElementById("eleSummary").innerHTML = "<p>"+ elements[indexNo]["summary"] +"</p>";

        // Element Images Tiles

        document.getElementById("phyPic").innerHTML = "<img src='"+elements[indexNo]["image"]["url"]+"' alt='Element Physical Photos' style='width: 100%; height: 100%;'>";
        
        let eleTileBgColor = this.classList[1];
        let bgColorVar = document.getElementById("eleSqBox");
        console.log(eleTileBgColor);
        switch(eleTileBgColor)
        {
            // document.getElementById("eleSqBox").style.background-color =1;
            case "ng":
                bgColorVar.style.backgroundColor = "hsl(300deg, 44%, 82%)";
                bgColorVar.style.borderColor = "hsl(300deg, 44%, 82%)";
                break;
            case "rnm":
                bgColorVar.style.backgroundColor = "hsl(120deg, 73%, 79%)";
                bgColorVar.style.borderColor = "hsl(120deg, 73%, 79%)";
                break;
            case "mtl":
                bgColorVar.style.backgroundColor = "(165deg, 58%, 76%)";
                bgColorVar.style.borderColor = "(165deg, 58%, 76%)";
                break;
            case "ptm":
                bgColorVar.style.backgroundColor = "hsl(192deg, 62%, 80%)";
                bgColorVar.style.borderColor = "hsl(192deg, 62%, 80%)";
                break;
            case "tm":
                bgColorVar.style.backgroundColor = "hsl(12deg, 87%, 85%)";
                bgColorVar.style.borderColor = "hsl(12deg, 87%, 85%)";
                break;
            case "ltd":
                bgColorVar.style.backgroundColor = "hsl(42deg, 62%, 76%)";
                bgColorVar.style.borderColor = "hsl(42deg, 62%, 76%)";
                break;
            case "act":
                bgColorVar.style.backgroundColor = "hsl(340deg, 67%, 88%)";
                bgColorVar.style.borderColor = "hsl(340deg, 67%, 88%)";
                break;
            case "ake":
                bgColorVar.style.backgroundColor = "hsl(60deg, 83%, 67%)";
                bgColorVar.style.borderColor = "hsl(60deg, 83%, 67%)";
                break;
            case "alk":
                bgColorVar.style.backgroundColor = "hsl(48deg, 77%, 64%)";
                bgColorVar.style.borderColor = "hsl(48deg, 77%, 64%)";
                break;
            case "ukn":
                bgColorVar.style.backgroundColor = "rgb(180, 180, 180)";
                bgColorVar.style.borderColor = "rgb(180, 180, 180)";
                break;
            default:
                bgColorVar.style.backgroundColor = "#ffffff";
                bgColorVar.style.borderColor = "#ffffff";
                break;
        }

        document.getElementById("paraAtomNo").innerText = elements[indexNo]["number"];
        document.getElementById("paraEleSymbole").innerText = elements[indexNo]["symbol"];        
        document.getElementById("paraEleName").innerText = elements[indexNo]["name"];
        document.getElementById("paraAtomMass").innerText = elements[indexNo]["atomic_mass"];

        let l = elements[indexNo]["shells"];
        document.getElementById("paraAtomShell").innerHTML ="";
        for (let i = 0; i < l.length; i++)
        {
            // console.log(l[i]);
            document.getElementById("paraAtomShell").innerHTML += l[i]+"<br>";
        }

        document.getElementById("bohrModelPhoto").innerHTML = "<img src='"+elements[indexNo]["bohr_model_image"]+"' alt='Element Bohr Model Photo' style='width: 100%; height: 100%;'>";
    }
